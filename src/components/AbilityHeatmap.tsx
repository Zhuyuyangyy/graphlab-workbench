...
export function AbilityHeatmap({ activeRoleId, syncPulse }: AbilityHeatmapProps) {
  return (
    <div className="heatmap-panel" aria-label="岗位能力热力矩阵" data-sync-pulse={syncPulse}>
      <div className="viz-heading">
        <span>Role x Ability Matrix</span>
        <strong>岗位能力热力矩阵</strong>
      </div>
      <div className="heatmap-grid" key={`heatmap-${syncPulse}`}>
