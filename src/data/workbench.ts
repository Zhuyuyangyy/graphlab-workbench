...
export const graphNodes: GraphNode[] = [
  ...
  { id: "business", label: "业务理解", sub: "能力", type: "skill", x: 105, y: 345, r: 30, color: "#008f9b", yearlyDemand: [52, 58, 66, 78, 88] },
  { id: "prototype", label: "原型设计", sub: "能力", type: "skill", x: 315, y: 335, r: 29, color: "#008f9b", yearlyDemand: [48, 56, 64, 70, 76] },
  { id: "aigc", label: "AIGC 工具链", sub: "能力", type: "skill", x: 250, y: 445, r: 34, color: "#008f9b", yearlyDemand: [18, 29, 48, 72, 91] },
  { id: "data", label: "数据分析", sub: "能力", type: "skill", x: 420, y: 235, r: 31, color: "#008f9b", yearlyDemand: [46, 54, 66, 75, 83] },
  { id: "etl", label: "ETL 管道", sub: "能力", type: "skill", x: 610, y: 210, r: 29, color: "#008f9b", yearlyDemand: [42, 48, 58, 70, 78] },
  { id: "governance", label: "数据治理", sub: "能力", type: "skill", x: 760, y: 165, r: 30, color: "#008f9b", yearlyDemand: [46, 54, 66, 75, 83] },
  { id: "stream", label: "实时计算", sub: "能力", type: "skill", x: 810, y: 275, r: 29, color: "#008f9b", yearlyDemand: [38, 47, 55, 67, 76] },
  { id: "sql", label: "SQL/仓库", sub: "能力", type: "skill", x: 468, y: 430, r: 28, color: "#008f9b", yearlyDemand: [60, 64, 68, 70, 73] },
  { id: "kg", label: "图谱建模", sub: "能力", type: "skill", x: 565, y: 465, r: 32, color: "#008f9b", yearlyDemand: [34, 42, 55, 69, 78] },
  { id: "nlp", label: "实体抽取", sub: "能力", type: "skill", x: 735, y: 455, r: 30, color: "#008f9b", yearlyDemand: [44, 50, 62, 73, 82] },
  { id: "neo4j", label: "图数据库", sub: "能力", type: "skill", x: 830, y: 405, r: 28, color: "#008f9b", yearlyDemand: [28, 36, 48, 61, 73] },
  { id: "reasoning", label: "关系推理", sub: "能力", type: "skill", x: 690, y: 535, r: 29, color: "#008f9b", yearlyDemand: [30, 39, 52, 66, 81] },
  { id: "prompt", label: "提示工程", sub: "能力", type: "skill", x: 338, y: 496, r: 25, color: "#008f9b", yearlyDemand: [12, 25, 46, 68, 84] },
  { id: "agent", label: "智能体编排", sub: "能力", type: "skill", x: 395, y: 518, r: 26, color: "#008f9b", yearlyDemand: [8, 18, 38, 62, 86] },
  { id: "evaluation", label: "模型评测", sub: "能力", type: "skill", x: 470, y: 500, r: 25, color: "#008f9b", yearlyDemand: [20, 31, 46, 65, 80] },
  { id: "privacy", label: "数据合规", sub: "能力", type: "skill", x: 700, y: 112, r: 24, color: "#008f9b", yearlyDemand: [40, 47, 59, 71, 82] },
  { id: "viz", label: "可视分析", sub: "能力", type: "skill", x: 594, y: 378, r: 25, color: "#008f9b", yearlyDemand: [36, 43, 57, 70, 79] },
  { id: "feature", label: "特征工程", sub: "能力", type: "skill", x: 520, y: 310, r: 24, color: "#008f9b", yearlyDemand: [50, 56, 63, 69, 76] },
  { id: "bi", label: "BI 看板", sub: "能力", type: "skill", x: 368, y: 165, r: 23, color: "#008f9b", yearlyDemand: [45, 51, 58, 64, 70] },
  ...
  { id: "contest", label: "竞赛题库", sub: "证据源", type: "data", x: 220, y: 70, r: 23, color: "#c69422" },
  { id: "resume", label: "学生简历", sub: "证据源", type: "data", x: 75, y: 430, r: 23, color: "#c69422" },
  { id: "report", label: "行业报告", sub: "证据源", type: "data", x: 120, y: 500, r: 24, color: "#c69422" },
  { id: "standard", label: "技能标准", sub: "证据源", type: "data", x: 845, y: 510, r: 23, color: "#c69422" },
  { id: "patent", label: "专利简报", sub: "证据源", type: "data", x: 750, y: 72, r: 22, color: "#c69422" },
];

export const graphEdges: GraphEdge[] = [
  ["job", "ai-pm"], ["job", "data-engineer"], ["job", "knowledge-analyst"], ["job", "prompt"],
  ...
  ["ai-pm", "prompt"], ["ai-pm", "agent"], ["ai-pm", "evaluation"], ["ai-pm", "viz"],
  ["data-engineer", "feature"], ["data-engineer", "privacy"], ["data-engineer", "bi"], ["data-engineer", "viz"],
  ["knowledge-analyst", "evaluation"], ["knowledge-analyst", "agent"], ["knowledge-analyst", "privacy"], ["knowledge-analyst", "viz"],
  ["paper", "agent"], ["paper", "evaluation"], ["paper", "prompt"], ["contest", "prototype"], ["contest", "agent"],
  ["resume", "business"], ["resume", "sql"], ["resume", "viz"], ["standard", "privacy"], ["standard", "governance"],
  ["standard", "evaluation"], ["patent", "agent"], ["patent", "reasoning"], ["report", "privacy"],
  ["aigc", "prompt"], ["prompt", "agent"], ["agent", "evaluation"], ["feature", "data"], ["bi", "data"], ["viz", "kg"],
];
